...
INSERT INTO `sys_user`(`id`, `avatar`, `nick_name`, `user_name`, `password`, `note`, `privilege`, `salt`, `state`, `is_deleted`, `creator_id`, `create_time`, `modifier_id`, `modify_time`, `remark`) VALUES (1, 'https://cdn.pixabay.com/photo/2019/08/11/18/59/icon-4399701_960_720.png', 'root', 'root', '9d724c03b11f5cdbf2361bbce3916359002b1cd57fd3291325e7c93f6094a468', NULL, '{}', '3tTs4o7km6Q6rhsYBsnp', '1', 0, 0, '2019-07-06 15:02:17', 1, '2019-08-02 15:07:20', NULL);
INSERT INTO `sys_user`(`id`, `avatar`, `nick_name`, `user_name`, `password`, `note`, `privilege`, `salt`, `state`, `is_deleted`, `creator_id`, `create_time`, `modifier_id`, `modify_time`, `remark`) VALUES (2, 'https://cdn.pixabay.com/photo/2019/08/11/18/59/icon-4399701_960_720.png', 'admin', 'admin', '4a49c8935bd3ca437b577262d5566fcf2cce725af1c6c892d4e3570722e1487e', '11', '{}', 'ELeGAKRKnc6S4DobMVxn', '1', 0, 1, '2019-07-18 11:10:30', 1, '2019-07-18 12:14:17', NULL);

INSERT INTO `sys_role`(`id`, `name`, `code`, `note`, `ext_fields`, `state`, `priority`, `is_deleted`, `creator_id`, `create_time`, `modifier_id`, `modify_time`, `remark`) VALUES (1, '超级管理员', 'ROLE_ROOT', '拥有最高管理权限', '{}', '1', 1, 0, 1, '2019-07-07 10:47:27', NULL, NULL, NULL);
INSERT INTO `sys_role`(`id`, `name`, `code`, `note`, `ext_fields`, `state`, `priority`, `is_deleted`, `creator_id`, `create_time`, `modifier_id`, `modify_time`, `remark`) VALUES (2, '管理员', 'ROLE_ADMIN', '拥有普通管理权限', '{}', '1', 2, 0, 1, '2019-07-13 18:31:01', 1, '2019-07-31 10:12:26', NULL);
...
INSERT INTO `sys_resource`(`id`, `code`, `name`, `path`, `method`, `map_class`, `attributes`, `note`, `priority`, `ext_fields`, `state`, `is_deleted`, `creator_id`, `create_time`, `modifier_id`, `modify_time`, `remark`) VALUES (1, 'sys:user:find', '系统用户-查询', '/v1/sys/user', 'GET', 'com.mango.sys.entity.SysUser', '[\"userName\", \"password\"]', '', 0, '{}', '1', 0, 1, '2019-07-13 18:03:27', 1, '2019-08-06 11:27:20', NULL);
